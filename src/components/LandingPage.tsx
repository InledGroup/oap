            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
               ...
               <div className="flex flex-col md:flex-row items-center gap-8 text-sm font-extrabold text-gray-400">
                  <div className="flex gap-8">
                     <a href="https://github.com/InledGroup/oap" className="hover:text-blue-600 transition-colors">{dict.landing_links_github}</a>
                     <a href="/privacy" className="hover:text-blue-600 transition-colors">{dict.landing_links_privacy}</a>
                     <a href="/terms" className="hover:text-blue-600 transition-colors">{dict.landing_links_terms}</a>
                  </div>
               </div>
            </div>
         </footer>
